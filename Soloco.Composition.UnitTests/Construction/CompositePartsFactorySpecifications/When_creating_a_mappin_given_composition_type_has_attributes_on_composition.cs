...
{
    [TestClass]
    public class When_creating_a_mappin_given_composition_type_has_attributes_on_composition
    {
        [Composite(typeof(Dependency1), typeof(Dependency2), typeof(Dependency3))]
